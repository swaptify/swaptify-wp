                        ...
                        <tbody>
                            <?php foreach ($visitor_types as $visitor_type): ?>
                                <tr>
                                    ...
                                    <td><?php echo(esc_html($visitor_type->key)); ?></td>
                                    <td><?php echo(esc_html(Swaptify::$slugPrefix . $visitor_type->slug)); ?></td>
                                    <td>
                                            <h3>Trigger on a Click</h3>
                                            <p>
                                                Add the class <code>swaptify-visitor-type-click-<?php echo(esc_attr($visitor_type->key)); ?></code> to a clickable element
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                with a value of <code><?php echo(esc_html($visitor_type->key)); ?></code> 
...
&lt;/script&gt;</code></pre>
                ...
                <form method="POST" action="/wp-admin/admin-post.php">
                    <?php wp_nonce_field('add_visitor_type', 'add_visitor_type'); ?>
                    <?php 
