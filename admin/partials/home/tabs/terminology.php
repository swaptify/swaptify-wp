...
<h4>Rules</h4>
<blockquote>Rules are sets of conditions used to determine which Swaps to show for given Segments. When there is a conflict between Visitor Types and Rules, Rules will override the Visitor Type. Rules can be made and edited on <a href="<?php echo(esc_url(Swaptify::$url)) ?>/rules" target="_blank"><?php echo(esc_html(Swaptify::$prettyUrl)) ?></a></blockquote>
...
<blockquote>
    ...
    <br /><br />
    <em>Note: if you edit any Segment or Swap outside of WordPress, you'll need to update your Default Content on WordPress, since the content is stored on WordPress. You can update it under <a href="<?php echo(esc_url(admin_url('admin.php?page=swaptify-default-content'))) ?>">Swaptify > Default Content</a>.</em>
</blockquote>
