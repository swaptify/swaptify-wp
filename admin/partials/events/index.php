                        ...
                        <tbody>
                            <?php foreach ($events as $event): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo(esc_html($event->type_name)); ?>
                                    </td>
                                    <td><?php echo(esc_html($event->key)); ?></td>
                                    <td>
                                        <?php if ($event->type == 'click'): ?>
                                            <p>
                                                Add the class <code>swaptify-event-click-<?php echo(esc_attr($event->key)); ?></code> to a clickable element
                                            </p>
                                            ...
                                            <p>
                                                ...
                                                with a value of <code><?php echo(esc_html($event->key)); ?></code> 
...
&lt;/script&gt;</code></pre>
                ...
                <form method="POST" action="/wp-admin/admin-post.php">  
                    <?php wp_nonce_field('create_event', 'create_event'); ?>
                    <?php 
