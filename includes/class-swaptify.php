...
class Swaptify 
{
    ...
    public function adminEventFieldContent()
    {
        ...
        $event_keys = $wpdb->get_results($query, 'OBJECT'); // phpcs:ignore
    ...
    public function adminVisitorTypeFieldContent()
    {
        ...
        $visitor_type_keys = $wpdb->get_results($query, 'OBJECT'); // phpcs:ignore
    ...
    public static function getDefaultContent(array $keys = [])
    {
        ...
        $default_contents = $wpdb->get_results($query, 'OBJECT'); // phpcs:ignore
    ...
    public static function userData($pageUrl = null)
    {
        ...
        $cookies = $wpdb->get_results($query, 'OBJECT'); // phpcs:ignore
    ...
    public static function getKeys($id = null)
    {
         ...
         * run the query
         */
        $segment_keys = $wpdb->get_results($query, 'OBJECT'); // phpcs:ignore
